...
def portal(give):
    ...
    while loop == True:
        ...
        print("Press 2 to purchase the laptop from Manufacturer:")
        ...
        #creating the list to store the purchase details
            ...
            more_purchase=input("Do you want to purchase more laptops?(Y/N)").upper()
            if more_purchase=="Y":
                return 
            ...
            grand_total = price_of_selected_item
